...
export const FilesPage = () => {
  ...
  const [selectedProviders, setSelectedProviders] = useState<Set<ProviderType>>(new Set(["Google", "Microsoft"]));
        ...
        <section className="space-y-8">
          <header className="space-y-4">
            <div>
              ...
              <p className="text-sm text-slate-600 mt-2">Browse files from all your connected cloud storage providers</p>
            </div>
          </header>
          ...
          <div className="bg-white p-8 rounded-lg shadow-md">
            <div className="text-center">
              ...
              <div className="flex gap-3 justify-center">
                ...
                <Link
                  to="/connections"
                  className="px-4 py-2 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300 transition text-center"
                >
                  Back to Connections
                </Link>
              </div>
            ...
            <div className="relative">
              ...
              {showFilterMenu && (
                <div className="absolute right-0 mt-2 w-64 bg-white rounded-lg shadow-lg border border-gray-200 z-10">
                  <div className="p-4">
                    <h3 className="text-sm font-semibold text-gray-900 mb-3">Filter by Provider</h3>
                    <div className="space-y-2">
                      {(["Google", "Microsoft"] as ProviderType[]).map((provider) => {
                        const meta = PROVIDER_META[provider];
                        return (
                          <label key={provider} className="flex items-center cursor-pointer hover:bg-gray-50 p-2 rounded">
                            <input
                              type="checkbox"
